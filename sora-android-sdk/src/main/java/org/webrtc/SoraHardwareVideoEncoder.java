...
class SoraHardwareVideoEncoder implements VideoEncoder {
  private static final String TAG = "SoraHardwareVideoEncoder";
  ...
  /**
   * Creates a new SoraHardwareVideoEncoder with the given codecName, codecType, colorFormat, key frame
   ...
   */
  public SoraHardwareVideoEncoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String codecName,
  ...
  private VideoCodecStatus initEncodeInternal() {
    ...
    try {
      ...
      Logging.d(TAG, "MediaCodec output format: " + MediaFormat.KEY_TEMPORAL_LAYERING + "=" +
              outputFormat.getString(MediaFormat.KEY_TEMPORAL_LAYERING) );
