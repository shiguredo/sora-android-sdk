...
public class SoraHardwareVideoEncoderFactory implements VideoEncoderFactory {
  private static final String TAG = "SoraHardwareVideoEncoderFactory";
  ...
  /**
   * Creates a SoraHardwareVideoEncoderFactory that supports surface texture encoding.
   *
   ...
   */
  public SoraHardwareVideoEncoderFactory(
   ...
   */
  public SoraHardwareVideoEncoderFactory(EglBase.Context sharedContext, boolean enableIntelVp8Encoder,
  ...
  @Deprecated
  public SoraHardwareVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {
  ...
  public VideoEncoder createEncoder(VideoCodecInfo input) {
    ...
    return new SoraHardwareVideoEncoder(new MediaCodecWrapperFactoryImpl(), codecName, type,
